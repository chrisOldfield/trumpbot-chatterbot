...
class TimeLogicAdapter(LogicAdapter):
	...
	def __init__(self , **kwargs):
		...
		self.positive = [ 'what time is it' , 'do you know the time' , 'do you know what time it is' ,
			'what is the time' ]
		
		self.negative = [ 'it is time to go to sleep' , 'what is your favorite color' , 'i had a great time' ,
			'what is' ]
