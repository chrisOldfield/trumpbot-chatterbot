...
class ChatBot(object):
	...
	def __init__(self , name , **kwargs):
		...
		self.logic.system_adapters.append(utils.initialize_class('chatterbot.logic.NoKnowledgeAdapter' , **kwargs))
	...
	def get_response(self , input_item , session_id=None):
		...
		previous_statement = self.conversation_sessions.get(session_id).conversation.get_last_response_statement()
	...
	def learn_response(self , statement , previous_statement):
		...
		if previous_statement:
			...
			self.logger.info('Adding "{}" as a response to "{}"'.format(statement.text , previous_statement.text))
