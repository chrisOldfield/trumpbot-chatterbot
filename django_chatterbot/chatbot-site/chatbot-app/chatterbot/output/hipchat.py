...
class HipChat(OutputAdapter):
	...
	def send_message(self , room_id_or_name , message):
		...
		message_url = "{}/v2/room/{}/message".format(self.hipchat_host , room_id_or_name)
	...
	def reply_to_message(self):
		...
		https://www.hipchat.com/sphinx/apiv2/method/reply_to_message
		"""
	...
	def process_response(self , statement , session_id=None):
		...
		self.chatbot.conversation_sessions.get(session_id).conversation[ -1 ][ 1 ].add_extra_data('hipchat_message_id' ,
			data[ 'id' ])
