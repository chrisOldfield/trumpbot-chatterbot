...
class Statement(models.Model):
	...
	text = models.CharField(unique=True , blank=False , null=False , max_length=255)
...
class Response(models.Model):
	...
	statement = models.ForeignKey('Statement' , related_name='in_response')
	
	response = models.ForeignKey('Statement' , related_name='responses')
	...
	def __str__(self):
		...
		return '{} => {}'.format(statement if len(statement) <= 20 else statement[ :17 ] + '...' ,
...
class Conversation(models.Model):
	...
	statements = models.ManyToManyField('Statement' , related_name='conversation' ,
