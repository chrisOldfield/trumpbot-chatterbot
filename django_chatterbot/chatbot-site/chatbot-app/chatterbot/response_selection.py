...
def get_first_response(input_statement , response_list):
	...
	"""
	logger = logging.getLogger(__name__)
	logger.info(u'Selecting first response from list of {} options.'.format(len(response_list)))
...
def get_random_response(input_statement , response_list):
	...
	logger = logging.getLogger(__name__)
	logger.info(u'Selecting a response from list of {} options.'.format(len(response_list)))
