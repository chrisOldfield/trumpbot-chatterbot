...
class Microsoft(InputAdapter):
	...
	https://sphinx.botframework.com/en-us/restapi/directline/#navtitle
	"""
	...
	def start_conversation(self):
		...
		response = requests.post(endpoint , headers=self.headers , verify=False)
		self.logger.info('{} starting conversation {}'.format(response.status_code , endpoint))
