...
## Local Setup:
 ...
 2. Run Flask by running `export FLASK_APP=app.py`, and then `flask run`
 3. Demo will be live at [http://localhost:5000/](http://localhost:5000/)

## Changing the training data to local corpus

Simply exchange the default trainer to the for the relative path of your own json corpus

`english_bot.train("../djtcorpus.json")`
